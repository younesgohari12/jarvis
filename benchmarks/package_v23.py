...
PKG_ROOT = 'Jarvis_v0.12.0'                                  # spec §37
ZIP_NAME = 'Jarvis_v0.12.0_Intelligence_v23.0.0.zip'
RELEASE_VERSION = 'v0.12.0-intelligence-v23.0.0'
BUILD_DATE = (2026, 9, 20, 18, 0, 0)                          # §36 normalized
...
EXCLUDED_DIRS = {
    ...
    'node_modules', 'blind_chunks', 'dist_v23', '.idea', '.vscode',
...
EXTERNAL_FINALIZATION = {
    'reports/v23/package_integrity.json',
    'reports/v23/package_inventory.json',
    'reports/v23/metadata_consistency.json',
    'reports/v23/security_package.json',
}
...
def write_manifest(root: str, files: list[str]) -> dict:
    manifest = {
        ...
        'release': RELEASE_VERSION + ' — LANGUAGE BRAIN PHASE 1',
...
def main() -> int:
    out_dir = os.path.abspath(sys.argv[1] if len(sys.argv) > 1
                              else os.path.join(BASE, 'dist_v23'))
    ...
    with open(os.path.join(BASE, 'reports', 'v23', 'package_inventory.json'),
              'w', encoding='utf-8') as f:
        json.dump(inventory, f, ensure_ascii=False, indent=2)
    with open(os.path.join(BASE, 'reports', 'v23', 'package_integrity.json'),
              'w', encoding='utf-8') as f:
