"""JARVIS v22.4.1 — FINAL packaging with release-integrity verification
(spec §5-§12, §36-§45, §65).
...
Packaging policy (documented in the audit document §10):
  reports/v22_4_1/package_integrity.json and
  reports/v22_4_1/metadata_consistency.json are EXTERNAL finalization
...
Usage: python benchmarks/package_v22_4_1.py <output_dir>
"""
...
RELEASE_VERSION = 'v0.11.0-intelligence-v22.4.1'
BUILD_DATE = (2026, 9, 19, 12, 0, 0)                          # §36 normalized
...
EXCLUDED_DIRS = {
    ...
    'node_modules', 'blind_chunks', 'dist_v22_4_1', '.idea', '.vscode',
...
EXTERNAL_FINALIZATION = {
    'reports/v22_4_1/package_integrity.json',
    'reports/v22_4_1/package_inventory.json',
    'reports/v22_4_1/metadata_consistency.json',
    'reports/v22_4_1/security_package.json',
}
...
def main() -> int:
    out_dir = os.path.abspath(sys.argv[1] if len(sys.argv) > 1
                              else os.path.join(BASE, 'dist_v22_4_1'))
    ...
    from benchmarks.v22_4_1_security import scan_package
    ...
    with open(os.path.join(BASE, 'reports', 'v22_4_1', 'package_inventory.json'),
              'w', encoding='utf-8') as f:
        json.dump(inventory, f, ensure_ascii=False, indent=2)
    with open(os.path.join(BASE, 'reports', 'v22_4_1', 'package_integrity.json'),
              'w', encoding='utf-8') as f:
